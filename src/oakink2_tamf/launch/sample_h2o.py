...
import pickle
import sys
sys.path.append('/data/data4/xuhang/OakInk2-TaMF/src/oakink2_tamf/launch/param')
...
def sample_worker(
    ...
    for sample_id in tqdm.tqdm(range(worker_sample_id_start, worker_sample_id_stop), ncols=150):
        ...
        # action_name = gt_sample["action_name"]
        ...
        if commit:
            ...
            save_dict_filepath = os.path.join(
                ckpt_path, "sample_h2o", run_cfg["debug"]["sample_save_offset"],
