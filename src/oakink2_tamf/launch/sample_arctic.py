...
from oakink2_tamf.model.interaction_segment_mdm import InterationSegmentMDM, HandPoseRegressionModel
    ...
    for sample_id in tqdm.tqdm(range(worker_sample_id_start, worker_sample_id_stop), ncols=150):
        ...
        if commit:
            save_dict_filepath = os.path.join(
                ckpt_path, "sample_arctic", run_cfg["debug"]["sample_save_offset"],
