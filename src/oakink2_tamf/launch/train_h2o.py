...
from oakink2_tamf.dataset.h2o_dataset import H2O
...
from ..model.loss_h2o import GenModelLoss
...
def reg_entry(config_reg: ConfigRegistry):
    ...
    config_reg.register(
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/train/data_single_hand.pkl",
    )
    config_reg.register(
        "data_obj_pc_path",
        prefix=PARAM_PREFIX__TRAIN,
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/train/obj.pkl",
    )
    config_reg.register(
        "text_json",
        prefix=PARAM_PREFIX__TRAIN,
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/train/text.json",
    )
    config_reg.register(
        "batch_size",
        prefix=PARAM_PREFIX__TRAIN,
    ...
    config_reg.register(
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/test/data_single_hand.pkl",
    )
    config_reg.register(
        "data_obj_pc_path",
        prefix=PARAM_PREFIX__TEST,
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/test/obj.pkl",
    )
    config_reg.register(
        "text_json",
        prefix=PARAM_PREFIX__TEST,
        ...
        source=ConfigEntrySource.COMMANDLINE_OVER_CONFIG,
        callback=abspath_callback,
        default="data_h2o/h2o/test/text.json",
    )
    config_reg.register(
        "batch_size",
        prefix=PARAM_PREFIX__TEST,
...
def run(rank, world_size, ckpt_cfg, run_cfg):
    ...
    dtype = torch.float32
    print(run_cfg["runtime"]['master_port'])
    print(run_cfg['train']['batch_size'])
    ddp_util.setup_ddp(rank, world_size, run_cfg["runtime"]['master_port'])
    ...
    weight_path = "/data/data0/xuhang/Text2HOI/checkpoints/h2o/pointfeat.pth"
