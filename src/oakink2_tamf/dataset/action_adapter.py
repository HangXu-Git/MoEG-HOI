...
class ActionRecognitionAdapter_arctic(torch.utils.data.Dataset):
    ...
    def __init__(self, interaction_segment_dataset):
        ...
        self.interaction_segment_dataset = interaction_segment_dataset
        self.action_list = [
            'place', 'open', 'lift', 'shake', 'cut', 'sprinkle', 'operate', 'close', 'grasp', 'type', 'point'
        ]
        self.max_action = len(self.action_list)
...
class ActionRecognitionAdapter_grab(torch.utils.data.Dataset):
    ...
    def __init__(self, interaction_segment_dataset):
        ...
        self.interaction_segment_dataset = interaction_segment_dataset
        self.action_list = [
            'switch on', 'set', 'clean', 'staple', 'take picture', 'use', 'brush', 'browse', 'chop', 'wear', 'see', 'screw', 'fly', 'inspect', 'stamp', 'lift', 'hand over', 'drink', 'open', 'cook', 'call', 'squeeze', 'play', 'shake', 'peel', 'eat', 'pour', 'toast', 'pass'
        ]
        self.max_action = len(self.action_list)
...
class ActionRecognitionAdapter_h2o(torch.utils.data.Dataset):
    ...
    def __init__(self, interaction_segment_dataset):
        ...
        self.interaction_segment_dataset = interaction_segment_dataset
        self.action_list = [
            'grab', 'pour', 'put in', 'place', 'spray', 'open', 'take out', 'squeeze', 'read', 'close'
        ]
        self.max_action = len(self.action_list)
